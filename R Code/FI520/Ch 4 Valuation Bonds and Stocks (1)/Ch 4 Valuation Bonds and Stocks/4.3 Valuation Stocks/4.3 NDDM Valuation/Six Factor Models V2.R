...
PredictedlnPVD <- Level + Slope*Factors2[1,] + Curvature1*Factors2[2,] +
  Curvature2*Factors2[3,] + Curvature3*Factors2[4,] + Curvature4*Factors2[5,]
...
for (j in 1:NumberOfMaturities){
  FittedlnPVD[i,j] = Level + Slope * Factors2[1,j] + Curvature1*Factors2[2,j] +
    Curvature2*Factors2[3,j] + Curvature3*Factors2[4,j] + Curvature4*Factors2[5,j]
}
# Plots
if(PlotlnPVD){
