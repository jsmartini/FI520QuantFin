# CMT Functions.R
# Functions:
#  AdjustDate(TM, TD, TY, Convention): Attempts to convert invalid dates to
#   valid and also move off week-ends and holidays
#  LSCRate(LSC): Estimates a single rate based on maturity and LSC model
#   Discount rate: Maturity is at end of period 
#   Forward rate: Maturity is at beginning of rate period
#  DiffCMTRates(x, NFac, S, NCMTs, MSR): Squared difference w discount curve  
#  CMTRates(y, NFac, S, NCMTs): With LSC, estimate CMT curve
#  DiscountRates(y, NFac, S, NCMTs): With LSC, estimate discount rates
#  OUT: PaymentsRemaining(N): Calculates number of payment dates remaining
#  OUT: NAD(N): Number of accrued days
#
...
#
DiffCMTRates <- function(x, NFac, S, NCMTs, MSR){
...
# SCRAPS
# #
# # PaymentsRemaining: Not used now?
# #
